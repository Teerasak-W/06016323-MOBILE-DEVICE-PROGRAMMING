...
export default function App() {
  ...
  const configureNewGameHandler = () => {
    setGuessRounds(0)// ...เพิ่มโค้ด...อัพเดทค่าสเตท guessRounds ให้เป็น 0
    setCorrectNumber(0)// ...เพิ่มโค้ด...อัพเดทค่าสเตท correctNumber ให้เป็น 0
  };
  ...
  const gameOverHandler = (numOfRounds) => {
    setGuessRounds(numOfRounds)//   ...เพิ่มโค้ด...อัพเดทค่าสเตท guessRounds ด้วยค่า numOfRounds ที่รับมา
  };
